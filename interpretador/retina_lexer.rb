...
# Tipos de datos
class Boolean < Token;      def to_s;   "linea #{$row}, columna #{$col}: tipo de dato \'#{@t}\'";  end; end
class Number < Token;       def to_s;   "linea #{$row}, columna #{$col}: tipo de dato \'#{@t}\'";  end; end

# Identificadores predefinidos
class OpenEye < Token;      def to_s;   "linea #{$row}, columna #{$col}: identificador de funcion \'#{@t}\'"; end; end
class CloseEye < Token;     def to_s;   "linea #{$row}, columna #{$col}: identificador de funcion \'#{@t}\'"; end; end
class Backward < Token;     def to_s;   "linea #{$row}, columna #{$col}: identificador de funcion \'#{@t}\'"; end; end
class Forward < Token;      def to_s;   "linea #{$row}, columna #{$col}: identificador de funcion \'#{@t}\'"; end; end
class RotateL < Token;      def to_s;   "linea #{$row}, columna #{$col}: identificador de funcion \'#{@t}\'"; end; end
class RotateR < Token;      def to_s;   "linea #{$row}, columna #{$col}: identificador de funcion \'#{@t}\'"; end; end
class SetPosition < Token;  def to_s;   "linea #{$row}, columna #{$col}: identificador de funcion \'#{@t}\'"; end; end
class Arc < Token;          def to_s;   "linea #{$row}, columna #{$col}: identificador de funcion \'#{@t}\'"; end; end
